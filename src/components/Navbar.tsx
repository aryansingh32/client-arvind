...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 animate-fade-down">
      {/* Utility bar — desktop only, extra breathing room above the main nav */}
      <div
        className={`hidden xl:block bg-charcoal text-ivory/55 overflow-hidden transition-[max-height,opacity] duration-300 ease-out ${
      ...
      <div
        className={`border-b transition-all duration-300 ${
          scrolled
            ? "bg-paper/95 border-concrete backdrop-blur shadow-[0_1px_0_rgba(0,0,0,0.02)]"
      ...
      >
        ...
        >
          <Link to="/" className="flex items-center gap-2 shrink-0" aria-label="Anand Techno-Fab LLP home">
            <img src="/images/logo.png" alt="Anand Techno-Fab LLP" className="h-9 xl:h-11 w-auto transition-all duration-300" />
          </Link>
